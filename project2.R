...
# Phosphorous$lyield <- log(Phosphorous$yield)
# Phosphorous$lolsenP <- log(Phosphorous$olsenP)
...
# plot(Phosphorous$olsenP,Phosphorous$lyield)
# plot(Phosphorous$lolsenP,Phosphorous$lyield)
